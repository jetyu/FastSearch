...
(function (vue, core) {
  ...
  const unpkg = "output/index.user.js";
  const jsdelivr = "output/index.user.js";
  ...
  const _sfc_main$d = {
    ...
    setup(props) {
      const { openInNewTab: openInNewTab2 } = useOpenInNewTab();
                        ...
                        vue.createVNode(_component_form_item, {
                          ...
                          default: vue.withCtx(() => [
                            vue.createVNode(_component_as_radio, {
                              ...
                              "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $setup.openInNewTab = $event)
                            }, {
                              default: vue.withCtx(() => [
                            ...
                            vue.createVNode(_component_as_radio, {
                              label: false,
                              modelValue: $setup.openInNewTab,
                              "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => $setup.openInNewTab = $event)
                            }, {
                              default: vue.withCtx(() => [
                        ...
                        vue.createVNode(_component_form_item, {
                          ...
                          default: vue.withCtx(() => [
                            vue.createVNode(_component_as_radio, {
                              ...
                              "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => $setup.toolbarVisible = $event)
                            }, {
                              default: vue.withCtx(() => [
                            ...
                            vue.createVNode(_component_as_radio, {
                              label: 2,
                              modelValue: $setup.toolbarVisible,
                              "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => $setup.toolbarVisible = $event)
                            }, {
                              default: vue.withCtx(() => [
                        ...
                        vue.createVNode(_component_form_item, { label: "方向" }, {
                          default: vue.withCtx(() => [
                            vue.createVNode(_component_as_radio, {
                              ...
                              "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => $setup.mode = $event)
                            }, {
                              default: vue.withCtx(() => [
                            ...
                            vue.createVNode(_component_as_radio, {
                              label: "vertical",
                              modelValue: $setup.mode,
                              "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => $setup.mode = $event)
                            }, {
                              default: vue.withCtx(() => [
                          ...
                          default: vue.withCtx(() => [
                            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($setup.alignList, ([key, value2]) => {
                              return vue.openBlock(), vue.createBlock(_component_as_radio, {
                                ...
                                "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => $setup.align = $event)
                              }, {
                                default: vue.withCtx(() => [
                          ...
                          default: vue.withCtx(() => [
                            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($setup.options, ([key, value2]) => {
                              return vue.openBlock(), vue.createBlock(_component_as_radio, {
                                ...
                                "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => $setup.scrollHide = $event),
                        ...
                        vue.createVNode(_component_form_item, { label: "图标" }, {
                          default: vue.withCtx(() => [
                            vue.createVNode(_component_as_radio, {
                              ...
                              "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => $setup.favicon = $event)
                            }, {
                              default: vue.withCtx(() => [
                                vue.createTextVNode("显示 ")
                              ]),
                            ...
                            vue.createVNode(_component_as_radio, {
                              label: 2,
                              modelValue: $setup.favicon,
                              "onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => $setup.favicon = $event)
                            }, {
                              default: vue.withCtx(() => [
                                vue.createTextVNode("隐藏 ")
                              ]),
                        ...
                        vue.createVNode(_component_form_item, { label: "主题色" }, {
                          default: vue.withCtx(() => [
                            vue.createVNode(_component_color, {
                              ...
                              "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => $setup.primaryColor = $event)
                            }, null, 8, ["modelValue"])
                          ]),
                          _: 1
                        }),
                        vue.createVNode(_component_form_item, { label: "文字色" }, {
                          default: vue.withCtx(() => [
                            vue.createVNode(_component_color, {
                              ...
                              "onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => $setup.primaryTextColor = $event)
                            }, null, 8, ["modelValue"])
                          ]),
                          _: 1
                        }),
  ...
  const hoverBtn = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$5], ["__scopeId", "data-v-5d991503"]]);
  const _sfc_main$4 = {
    name: "iconfont"
  };
  ...
  const selectionBar = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["__scopeId", "data-v-18d00e32"]]);
  const _sfc_main$2 = {
    name: "as-dialog",
    model: {
      prop: "visible",
