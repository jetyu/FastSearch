...
- 网盘分类保留百度网盘，并新增 PanSearch 和小酷盘；新闻分类新增人民网、央视网、澎湃新闻和中新网；百科分类新增快懂百科。
- 新增高德地图、百度地图、谷歌地图组成的“地图”分类；更新后内置菜单共 13 个分类、87 个网址入口。
...
“搜索”分类内置 5 个 AI 助手入口，所有入口都会带入当前搜索词。
...
1. 安装 `output/index.user.js`，刷新搜索结果页，打开“设置 → 网址管理 → 打开”，确认标题显示 `1.5.21`，有“配置 / 编辑 / 划词工具栏”三个 Tab，各 Tab 底部只有“取消 / 保存”。
